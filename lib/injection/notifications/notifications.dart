...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showNotification() async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails('10001', 'MStroy', 'MStroy ',
  ...
  Future<void> _showNotificationCustomVibrationIconLed() async {
    ...
    final AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails('other custom channel id',
            'other custom MStroy', 'other custom channel description',
            icon: 'secondary_icon',
  ...
  Future<void> _showNotificationWithNoSound() async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails(
            'silent channel id', 'silent MStroy', 'silent channel description',
            playSound: false,
  ...
  Future<void> _showSoundUriNotification() async {
    ...
    final AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails(
            'uri channel id', 'uri MStroy', 'uri channel description',
            sound: uriSound,
  ...
  Future<void> _showBigPictureNotification() async {
    ...
    final AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails('big text channel id', 'big text MStroy',
  ...
  Future<void> _showInboxNotification() async {
    ...
    final AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails(
            'inbox channel id', 'inboxMStroy', 'inbox channel description',
  ...
  Future<void> _showMessagingNotification() async {
    ...
    final MessagingStyleInformation messagingStyle = MessagingStyleInformation(
        ...
        messages: messages);
    final AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails('message channel id', 'message MStroy',
  ...
  Future<void> _showGroupedNotifications() async {
    ...
    const String groupChannelName = 'grouped MStroy';
  ...
  Future<void> _repeatNotification() async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails('repeating channel id', 'repeating MStroy',
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
        ...
        const NotificationDetails(
          android: AndroidNotificationDetails('daily notification channel id',
              'daily notification MStroy', 'daily notification description'),
        ),
        androidAllowWhileIdle: true,
        uiLocalNotificationDateInterpretation:
            UILocalNotificationDateInterpretation.absoluteTime,
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
        ...
        const NotificationDetails(
          android: AndroidNotificationDetails('weekly notification channel id',
              'weekly notification MStroy', 'weekly notificationdescription'),
        ),
        androidAllowWhileIdle: true,
        uiLocalNotificationDateInterpretation:
            UILocalNotificationDateInterpretation.absoluteTime,
  ...
  Future<void> _showNotificationUpdateChannelDescription() async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
        AndroidNotificationDetails('your channel id', 'your MStroy',
